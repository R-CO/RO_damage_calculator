...
#ifndef _CHARACTER_STATES_H_
#define _CHARACTER_STATES_H_
...
public:
    CharacterStates(
        int level = 175, int job_level = 60, 
...
private:
    ...
    int dex_extra_;
    int luk_extra_;
}; // end of class "CharacterStates"

} // end of namespace "rco"

#endif // end of define "_CHARACTER_STATES_H_"
